"""Vite 6 + React 19 Framework Generator for polyglot-framework-exporter.

Generates complete, runnable, production-ready Vite 6 + React 19 + TypeScript + Tailwind CSS
single-page application with Master Theme tokens and interactive React components.
"""
...
class ViteReactGenerator:
    """Generates a complete Vite 6 + React 19 project with Master Theme integration."""

    name = "vite_react"
    display_name = "Vite 6 + React 19"
    description = "Ultra-fast client SPA with Vite 6, React 19, TypeScript, and Tailwind CSS."
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 pt-8 border-t border-border-subtle flex flex-col sm:flex-row items-center justify-between text-xs text-text-muted gap-4">
          ...
          <div className="flex gap-4">
            <span>Powered by Vite 6 + React 19</span>
          </div>
        </div>
      </div>
    </footer>
...
"""
        files["vercel.json"] = json.dumps({"framework": "vite"}, indent=2)

        files["README.md"] = f"""# {ast.title} (Vite 6 + React 19)
